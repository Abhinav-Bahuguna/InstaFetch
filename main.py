...
def requestUserDataViaInstaApi(headers, cookies, data, retries=3, backoff_factor=2):
    ...
    query_result = response['data']['xdt_api__v1__feed__user_timeline_graphql_connection']
...
def getUserData(username):
    ...
    while(page_info['has_next_page']):
        ...
        edges, page_info = requestUserDataViaInstaApi(headers.headers, cookies.cookies, data)
        _data.extend(edges)
